...
SPECTACULAR_SETTINGS = {
    # Optionnel : si tu veux personnaliser le titre etc.
    'TITLE': 'EmunieBack API',
    'DESCRIPTION': 'Documentation de l\'API EmunieBack',
    'VERSION': '1.0.0',
    
    # Spécifie que Swagger UI doit être servi via le package local (tu peux aussi forcer un CDN)
    'SWAGGER_UI_DIST': 'drf_spectacular.swagger_ui.dist',  # Valeur par défaut
}
